	...
	private void calcularResultado() {
		if (operacion.equals("+")) {
			...
			resultado /= new Double(pantalla.getText());
                    ...
                    NumeroP = new Double(pantalla.getText());
			resultado = Math.pow(resultado, NumeroP);
		}else if (operacion.equals("Cos")) {
                    NumeroP = new Double(pantalla.getText());
			resultado = Math.cos(NumeroP);
		}else if (operacion.equals("Tan")) {
                    NumeroP = new Double(pantalla.getText());
			resultado = Math.tan(NumeroP);
		}else if (operacion.equals("Sen")) {
                    NumeroP = new Double(pantalla.getText());
			resultado = Math.sin(NumeroP);
		} else if (operacion.equals("*")) {
			resultado *= new Double(pantalla.getText());
		}
